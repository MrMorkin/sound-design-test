...
namespace Invector.vCharacterController.AI
{
    ...
    public abstract class vAIMotor : vHealthController, vICharacter
    {
        ...
        [HideInInspector]
        public bool stepUp, jumpOver, climbUp, landHigh, isRolling, isUsingLadder, lockMovement, lockRotation, stopMove, inTurn, isJumping, doingCustomAction;
        ...
        protected virtual void FreeMovement()
        {
            ...
            if (input != Vector3.zero && targetDirection.magnitude > 0.2f && conditions)
            {
                ...
                if (!lockRotation && !inTurn && !isRolling && speed > 0.1f && !ragdolled)
