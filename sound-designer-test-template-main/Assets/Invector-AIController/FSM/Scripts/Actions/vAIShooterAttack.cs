...
{
#if UNITY_EDITOR
    [vFSMHelpbox("This is a attack for shooter character\n Using aim behaviour and attack behaviour", UnityEditor.MessageType.Info)]
#endif
    ...
    {       
        ...
        [vHideInInspector("useRandomAttackType")][Tooltip("Use values between 0 and 100")]
